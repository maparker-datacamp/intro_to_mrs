...
description : Introduction to Revolution R Enterprise
...
- DevelopR comes with the Linux installation of RRE
...
test_mc(correct = 4, 
        ...
        feedback_msgs = c("Incorrect - DevelopR is part of Windows RRE installations.",
                          "Incorrect - try again.",
...
test_mc(correct = 4, 
        no_selection_msg = "Please make a selection!", 
        feedback_msgs = c("Incorrect - DistributedR is the RRE component for managing distributed computing contexts.",
                          "Incorrect - DevelopR is the visual development environment included with RRE.",
                          "Incorrect - DeployR is the RRE component for setting up web services.",
                          "Correct! ScaleR is the RRE component that includes statistical and machine learning algorithms like linear models.",
                          "Incorrect - ConnectR is the RRE component that enables connections to different data sources."
))
...
test_mc(correct = 1, 
        no_selection_msg = "Please make a selection!", 
        feedback_msgs = c("Correct! In most cases, RRE code can be moved to a new platform by simply specifying a different 'compute context'.",
                          "Incorrect - in most cases, RRE code can be moved to a new platform by simply specifying a different 'compute context'."
))
```
