...
entail these three expressions:
 ...
 The RRE syntax is nearly the same as a single transformation; just separate
...
In Revolution R Enterprise, you can use `rxDataStep` to subset an XDF file.
