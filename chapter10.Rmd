...
There are a couple of ways to create factors in RRE, but the `rxFactors` function
...
success_msg("Good work. That's the simplest way to create factors from other variables in RRE.")
